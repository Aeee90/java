...
import com.example.demo.TobyApplication;
import com.example.demo.TobyApplication.MyService;
...
public class Example09 {
	...
	public static void main(String[] args) { SpringApplication.run(Example09.class, args); }
